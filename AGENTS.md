...
A mobile PWA to help stay-at-home moms manage tasks, projects, kids, and home life — framed as an RPG adventure. Built with React, React Router, Firebase, and Codex (LLM integration planned).
